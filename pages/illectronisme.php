...
<body>
    ...
    <div class="content">
        <div class="container-title">
            <h1 class="title_1">L’illectronisme</h1>
            <h1 class="title_2">Qu’est-ce que l’illectronisme ? </h1>
        </div>


        <div class="container-texte">
            <p class="texte">« Etat d’une personne qui ne maîtrise pas les<br> compétences nécessaires à l’utilisation et à la création<br> des ressources numérique ».
            </p>
        ...
        <div class="container-texte-6">

            <p>
                De nombreuses personnes ont perdu en productivité, éprouvent désormais du mal à communiqué et collaborer avec leurs collègues dus à leurs lacunes en informatique.<br><br>
                <span class="text_color">Les métiers évoluent rapidement, l’utilisation de l’informatique prend de plus en plus de place au quotidien et cela entraine une exclusion involontaire des personnes qui ne maitrisent pas ces outils.</span>
                <br>
                De plus, viennent s’ajouter aux problèmes de compréhension numérique, les problèmes d’accessibilité physique.<br> Les personnes atteintes de certains handicaps ne possèdent pas les capacités pour naviguer sur Internet.<br><br>
        ...
        <div class="container-title-2">
            <h1 class="title_2">Sensibiliser à ce sujet </h1>
        </div>
        ...
        <div class="container-texte-10">
            ...
            <button id="button">Rendre son site accessible</button>

        </div>



        <div class="container-texte-11">

            <a href="#" class="" id="fitter-2">

...
<div class="mainWrap4">
    <h1 id="mainWrap4_title">Quels sont leurs différents usages d’internet ?</h1>
...
<div class="mainWrap6">
    ...
    L’utilisation du numérique est un avantage indéniable, mais tout ça dépend de leur niveau de maitrise ainsi que leur confiance dans leur pratique du web.<span class="orangeP">Pour pouvoir inciter plus de séniors à utiliser Internet, il est essentiel de s’intéresser et de comprendre pourquoi certains rencontrent des problèmes et quels sont ces freins.</span>
</p></div>
    <div></div>
...
<div class="lastWrap">
    ...
    <p><span class="orangeP">Parmi les séniors, plus de la moitié des 75 ans et plus, disent éprouver des difficultés avec Internet et leurs équipement numérique.</span> Ces écueils sont dû à plusieurs raisons, La première est que la majorité d’entre eux ne ressentent pas le besoin et ni l’intérêt de son utilisation.<br><br> 
    ...
    Pour beaucoup de personnes qui ne possèdent pas de connaissances digitales la peur du vol de données et les potentiels risque de sécurité pour leurs matériels, les empêches de profiter pleinement de l’outil.</span>
    </p>
    </div>
    <div></div>
